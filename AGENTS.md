...
- Die Datenbank und Settings-Schema werden nicht unnötig erweitert.Ziel von v0.5.1 ist die stabile Windows-Kamera-Integration mit ROI, Snapshot, gekapselter Brickognize-Erkennung, Bounding Box und hintergrundgestützter Farbanalyse.
# AGENTS.md
