...
BrickManager ist eine Kivy-Anwendung zur Verwaltung und Sortierung von Bauteilen. Ziel von v0.2 ist die stabile Windows-Kamera-Integration ohne Brick-Erkennung oder andere spätere Funktionen einzubauen.
...
- Keine Brickognize-, Online-, YOLO-, ROI-, Snapshot-, AUTO-Scan- oder Inventar-Funktionen in v0.2.
...
- Kein Aufwand für Funktionen, die noch nicht Teil von v0.2 sind.
...
- `brickmanager/recognition/`, `database/`, `services/` bleiben in v0.2 grundsätzlich unverändert.
